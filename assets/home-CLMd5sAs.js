import{S as eh,G as th,a as nh}from"./Grid-9Uy6lrNu.js";import{_ as Ka,r as $i,b as On,k as Ar,x as zs,o as bn,F as Co,f as Po,i as gc,e as zn,n as ih,d as Ec,h as rh,A as sh,D as ah,y as oh,u as lh}from"./index-DW9owHNU.js";const ch="/yahua/assets/video1-CdzsSNUU.mp4",uh="/yahua/assets/video2-BqgJaATb.mp4",hh="/yahua/assets/video3-DRrDmEJd.mp4",fh=["src"],dh=["src"],ph={class:"content-wrapper"},mh=["innerHTML"],_h=["onClick"],gh={__name:"VideoSection",setup(r){const e=[{src:hh,title:"科技创新，启航未来"},{src:uh,title:"探索智能，连接世界"},{src:ch,title:"创意视觉，展现无限"}],t=$i(0),n=$i(),i=$i(Array(e.length));return(s,o)=>(bn(),On("div",null,[Ar(eh,{ref_key:"swiperRef",ref:n,interval:8e3,"pause-on-hover":!0,style:{height:"100vh"},onChange:o[0]||(o[0]=a=>{t.value=a,i.value[a]&&(i.value[a].currentTime=0)})},{default:zs(()=>[(bn(),On(Co,null,Po(e,(a,l)=>Ar(nh,{key:a.title},{default:zs(()=>[a.pictureUrl?(bn(),On("img",{key:0,src:a.pictureUrl,class:"banner",alt:""},null,8,fh)):a.src?(bn(),On("video",{key:1,src:a.src,ref_for:!0,ref:c=>i.value[l]=c,class:"banner",autoplay:"",muted:"",loop:""},null,8,dh)):gc("",!0),zn("div",ph,[zn("div",{class:"title",innerHTML:a.title},null,8,mh)])]),_:2},1024)),64))]),_:1},512),Ar(th,{columns:e.length,gap:"0.4rem",class:"dots"},{default:zs(()=>[(bn(),On(Co,null,Po(e,(a,l)=>zn("div",{class:"dot-item",key:a.title,onClick:c=>n.value.goTo(l)},[zn("div",{class:ih(["line",{active:l===t.value}])},null,2)],8,_h)),64))]),_:1},8,["columns"])]))}},Eh=Ka(gh,[["__scopeId","data-v-f4c935c1"]]);/**
 * @license
